...
public class ArmorBarRenderer {
    ...
    public static void render(DrawContext ctx, PlayerEntity player, int xLeft, int y) {
        ...
        // 3. Disegna Materiali e Trim
        renderMaterialAndTrims(ctx, xLeft, y);

        // 4. Disegna Incantesimi
        renderEnchantments(ctx, player, xLeft, y);
    }
    ...
    private static void renderMaterialAndTrims(DrawContext ctx, int xLeft, int y) {
        for (int slot = 0; slot < 10; slot++) {
            ...
            // Logica FULL (stesso materiale e stesso trim)
    ...
    private static void renderEnchantments(DrawContext ctx, PlayerEntity player, int xLeft, int y) {
